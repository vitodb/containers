  ...
  sources: {
    jobs_manifests: {
      ...
      parameters: {
        ...
        collector_host: "decisionengine-workspace.glideinwms.org",
        schedds: [
          "decisionengine-workspace.glideinwms.org"
        ],
        constraint: "True",
        classad_attrs: [
          "ClusterId",
  ...
  transforms: {
    t_job_categorization: {
      ...
      parameters: {
        match_expressions: [
          {
            job_bucket_criteria_expr: "(DESIRED_Sites=='ce-workspace.glideinwms.org')",
            frontend_group: "de_test",
            site_bucket_criteria_expr: [
              "GLIDEIN_Site=='ce-workspace.glideinwms.org'"
            ]
          }
        ],
  ...
  publishers: {
    JobClusteringPublisher: {
      ...
      parameters: {
        ...
        graphite_port: 2004,
        graphite_context: "hepcloud.de.decisionengine-workspace.glideinwms",
